...
pub(crate) struct KairoAerodromeApp;
...
pub(crate) struct WalletOnlyArgs {
...
#[derive(Debug, Deserialize, JsonSchema)]
pub(crate) struct GaugeSignalArgs {
...
#[derive(Debug, Deserialize, JsonSchema)]
pub(crate) struct GetPolicyArgs {
...
#[derive(Debug, Deserialize, JsonSchema)]
pub(crate) struct ProposeActionArgs {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) to_pool: Option<String>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) projected_apr_delta_bps: Option<u32>,

    /// Projected impermanent loss in basis points (rebalance only).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) projected_impermanent_loss_bps: Option<u32>,

    /// Estimated reward USD for claim_rewards.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) estimated_reward_usd: Option<f64>,

    /// Vote weight in basis points (vote_for_gauge only, 0-10000).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) weight_bps: Option<u32>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) amount_in_usd: Option<f64>,
    /// Expected amount out in USD (swap only).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) expected_amount_out_usd: Option<f64>,
...
#[derive(Debug, Deserialize, JsonSchema)]
pub(crate) struct GetReceiptArgs {
